...
const BUTTON_CLOSE_NEW = document.querySelector(".croix2");
const BUTTON_BACK = document.querySelector(".fleche_gauche");
const BUTTON_ADD = document.querySelector(".buttonAjoutProjet2");
const INPUT_PICTURE = document.querySelector("#input-picture");
const PICTURE_PREVIEW = document.querySelector("#picture-preview");
const PICTURE_SELECTION = document.querySelector(".imageSelect");
const CATEGORIES_SELECT = document.querySelector(".selectCategory");
...
const OPEN_MODAL_NEW = function (e) {
  console.log("Function OPEN_MODAL_NEW called");
  e.preventDefault();
  ...
  let modal_wrapper = document.querySelector(".modalWrapper2");
...
document.querySelectorAll("#ajoutUnProjet").forEach((a) => {
